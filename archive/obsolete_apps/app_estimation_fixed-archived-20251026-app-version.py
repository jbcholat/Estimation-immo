        ...
        with st.spinner("Recherche des comparables..."):
            ...
            if len(comparables) > 0:
                ...
                if estimation:
                    ...
                    comparables_display = comparables.head(15).copy()
                    ...
                    comparables_display['ville_nom'] = comparables_display['commune'].apply(code_to_ville)
                    ...
                    for idx, comp in comparables_display.iterrows():
                        ...
                        with st.expander(f"📍 {comp['ville_nom']} - {comp['prix_format']} - {comp['pertinence']}"):
                            col1, col2, col3 = st.columns(3)
                            with col1:
                            ...
                            with col3:
                                ...
                                st.write(f"**Commune :** {comp['ville_nom']}")
                                st.write(f"**État :** Standard")
                    ...
                    fig = px.scatter(
                        ...
                        size='valeurfonc',
                        color='pertinence',
                        hover_data=['ville_nom', 'date_vente'],
